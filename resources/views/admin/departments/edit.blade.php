                            ...
                            <select name="division" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Division --</option>
                                                                        @foreach($divisions as $division)
                                                                            <option class='py-4' value="{{$division->id}}" @if ($division->id == $department->division_id) selected @endif>{{$division->division_name}} ({{$division->short_name}})</option>
                                                                        @endforeach                                                                    
                                                                    </select>
                            ...
                            <select name="parent_department" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Parent Department --</option>
                                                                        @foreach($parent_departments as $parent)
                                                                            <option class='py-4' value="{{$parent->id}}" @if($parent->id == $department->parent_department) selected @endif>{{$parent->department_name}} ({{ $parent->short_name }})</option>
                                                                        @endforeach                                                                    
                                                                    </select>
