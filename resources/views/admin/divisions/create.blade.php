<x-admin-layout>
    ...
    <div class="flex flex-col border-0 w-[89%] md:w-[93%] mx-auto">
        ...
        <section class="py-8 mt-2">
                <div>
                    <form  action="{{ route('admin.divisions.store') }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
    
                        
    
                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >Create Division</h2>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-3">
                            ...
                            <select name="division_type" class="border border-1 border-gray-400 bg-gray-50
                                            ...
                                            @foreach($division_types as $division_type)
                                                <option value="{{ $division_type->id }}"'>{{ $division_type->division_type_name }}</option>
                                            @endforeach
