<x-admin-layout>
    ...
    <div class="flex flex-col border-0 w-[95%]  mx-auto">
        ...
        <section class="flex flex-col w-full md:w-full py-6 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            ...
                            <a href="{{ route('admin.divisions.create') }}" class="border border-green-600 text-green-600 py-2 px-6 
                                            rounded-lg text-xs md:text-sm hover:bg-green-600 hover:text-white hover:border-green-600">Create Division</a>
                    </div>
            </div>
        </section>
        <!-- end of page header //-->
        ...
        <section class="flex flex-col w-[95%] md:w-[95%] mx-auto py-2 mt-2 border-0">
                   


        @if ($divisions->count())
                    <div class='flex flex-col w-full md:flex-row md:items-center'>
                        <div class='py-1 text-xl font-medium md:w-1/2'>Divisions ({{ $divisions->count() }})</div>

                        <!-- Search //-->
                        <div class='flex flex-col gap-2 w-full py-2 md:py-2 md:w-1/2 md:justify-end md:items-end border-0'>
                                <form action="{{ route('admin.divisions.index') }}" method="GET" class="flex flex-row items-center w-full border-0">
                    ...
                    <table class="table-auto border-collapse border border-1 border-gray-200 w-[100%]">
                        <thead>
                            <tr class="bg-gray-200">
                                <th width='10%' class="text-center font-semibold py-4 w-16">#</th>
                                <th width='30%' class="font-semibold py-2 text-left">Name</th> 
                                <th width='20%' class="font-semibold py-2 text-left">Type</th> 
                                <th width='25%' class="font-semibold py-2 text-left">Parent</th> 
                            ...
                            <tr class="border border-b border-gray-200 ">
                                ...
                                <td class="py-4 pr-4">
                                    ...
                                    <div class='py-1'>
                                            ...
                                            <a class="font-semibold text-blue-800 underline" href="{{ route('admin.divisions.show',['division'=>$division->id]) }}">
                                                {{ $division->division_name }}
                                            </a>                             
                                    </div>
                                    <div class='flex flex-wrap md:flex-row gap-3 md:gap-4 text-sm'>
                                            <a href="#" class='hover:underline'>Sub Division (0)</a>
                                            <a href="#" class='hover:underline'>Departments (0)</a>
                                ...
                                <td>
                                    {{ $division->division_type->division_type_name }}
                                </td>
                                <td></td>
                                <td>
                                                <span class="text-sm">
                                                ...
                                                <span class="text-sm">
                                                        <a class="hover:bg-red-500 bg-red-400 text-white rounded 
                                                            px-4 py-1 text-xs" href="{{ route('admin.divisions.confirm_delete',['division' => $division->id]) }}">Delete</a>
                                                </span>
            ...
            @else
                    <section class="flex flex-col w-[95%] md:w-[95%] mx-auto px-0 py-8 border-0">
                        <div class="flex flex-row border-0 justify-center text-2xl font-semibold text-gray-300">
                                There is currently no Divisions
                        </div>
                    </section>
            @endif
